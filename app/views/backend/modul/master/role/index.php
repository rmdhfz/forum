<div class="card">
    <div class="card-body">
        ...
        <h5 class="card-title fw-semibold mb-4">Data Role</h5>
        <div class="card-body">
                ...
                <div class="container">
                    <form id="form" method="post" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" required placeholder="role" minlength="4" maxlength="25" pattern="[a-zA-Z\s]{4,25}" />
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        form.submit(function (event) {
            ...
            let id = $("#id").val();
            id === "" ? (url = "master/role/create") : (url = "master/role/update");
